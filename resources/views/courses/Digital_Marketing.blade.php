            ...
            <div class="row">
                    ...
                    <div class="container">
                        <div class="row g-5 justify-content-center">
                            <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                                ...
                                <p>Start at the beginning by learning the fundamentals of digital marketing — including
                                    SEO, social media, email campaigns, paid advertising, and content strategy. Build a
                                    strong foundation to effectively promote products or services online, attract the
                                    right audience, and drive business growth through proven marketing techniques.
                                </p>
                                <div class="d-flex">
                    ...
                    <div class="container-fluid wow fadeInUp mt-5 tabs">
                        ...
                        <div class="tab-content mt-4">
                            <div class="tab-pane container active" id="Overview">
                                ...
                                <p>This beginner-friendly Digital Marketing course teaches you the essentials of SEO,
                                    social media, email marketing, paid ads, and content strategy. Learn step by step
                                    with real-world examples and tools. By the end, you'll be ready to run effective
                                    online campaigns and grow any brand or business.
                                </p>
                                <h2 class="mt-4">Skills you'll gain</h2>

                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">SEO (Search Engine Optimization)</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Social Media Marketing</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Email Marketing</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Content Creation and Strategy</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Paid Advertising (Google Ads, Meta Ads)</span>
                            </div>
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> What is Digital Marketing?</li>
                                                    <li><i class="fa fa-video text-danger"></i> Importance in the Modern Business World</li>
                                                    <li><i class="fa fa-video text-danger"></i> Key Digital Channels Overview</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> On-Page and Off-Page SEO</li>
                                                    <li><i class="fa fa-video text-danger"></i> Keyword Research Basics</li>
                                                    <li><i class="fa fa-video text-danger"></i> SEO Tools and Best Practices</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Platform Overview (Facebook, Instagram, LinkedIn)</li>
                                                    <li><i class="fa fa-video text-danger"></i> Content Planning and Scheduling</li>
                                                    <li><i class="fa fa-video text-danger"></i> Community Engagement Strategies</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Building and Segmenting Email Lists</li>
                                                    <li><i class="fa fa-video text-danger"></i> Crafting Effective Campaigns</li>
                                                    <li><i class="fa fa-video text-danger"></i> Tools and Metrics</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Introduction to Google Ads</li>
                                                    <li><i class="fa fa-video text-danger"></i> Social Media Ads (Meta, LinkedIn)</li>
                                                    <li><i class="fa fa-video text-danger"></i> Budgeting and Performance Tracking</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseSix" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Creating Engaging Content</li>
                                                    <li><i class="fa fa-video text-danger"></i> Blogging and Video Strategy</li>
                                                    <li><i class="fa fa-video text-danger"></i> Repurposing Content Across Platforms</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseSeven" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Using Google Analytics</li>
                                                    <li><i class="fa fa-video text-danger"></i> Interpreting Key Metrics</li>
                                                    <li><i class="fa fa-video text-danger"></i> A/B Testing and Campaign Optimization</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseEight" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Design a Complete Marketing Campaign</li>
                                                    <li><i class="fa fa-video text-danger"></i> Apply Tools and Strategies Learned</li>
                                                    <li><i class="fa fa-video text-danger"></i> Present Your Marketing Plan</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="container" id="Instructor">
                                ...
                                <div class="image-div text-left mt-4">
                                    ...
                                    <div class="des mt-4 mb-5">
                                        Curriculum Director at Codecademy and experienced digital marketing educator. He
                                        has designed and led the development of core courses such as Digital Marketing
                                        Essentials, Learn E-Commerce, and Online Store Management. With a strong
                                        emphasis on real-world application, his work empowers beginners to master the
                                        fundamentals of digital marketing — including SEO, content creation, email
                                        campaigns, and social media strategy — preparing them to grow brands and succeed
                ...
                <div class="col-lg-3 col-md-6 shadow wow fadeInUp" data-wow-delay="0.3s">
                    <div class="image text-center">
                        <img class="img-fluid mt-2" src="{{ asset('img/course-7.jpg') }}" alt="" height="200px" width="500px">
                    </div>

                    <h4 class="mt-2 p-2">Rs.<small><del>50K</del></small></h4>
                    <h4 class="mt-2 p-2">RS.<small>30K</small></h4>
