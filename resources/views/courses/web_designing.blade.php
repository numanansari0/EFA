            ...
            <div class="row">
                    ...
                    <div class="container">
                        <div class="row g-5 justify-content-center">
                            <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                                <h2>Web Designing</h2>
                                <p>Start at the beginning by learning HTML, CSS, JavaScript & Bootstrap basics — an important foundation for building and editing web pages.</p>
                                <div class="d-flex">
                    ...
                    <div class="container-fluid wow fadeInUp mt-5 tabs">
                        ...
                        <div class="tab-content mt-4">
                            <div class="tab-pane container active" id="Overview">
                                ...
                                <p>This Web Designing course is perfect for anyone who wants to learn how to build websites. You will learn how to use tools like HTML, CSS, and JavaScript to create modern, mobile-friendly websites. No previous experience is needed — we start from the basics and guide you step by step. By the end of the course, you will be able to design and build your own website with confidence.</p>

                                <h2 class="mt-4">Skills you'll gain</h2>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2" style="font-size: 15px; font-weight: normal;">Structure pages with HTML & CSS</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2" style="font-size: 15px; font-weight: normal;">Responsive Design</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2" style="font-size: 15px; font-weight: normal;">JavaScript Basics</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2" style="font-size: 15px; font-weight: normal;">Web Layouts & Frameworks</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2" style="font-size: 15px; font-weight: normal;">Code Editors & Tools</span>
                            </div>
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <ul>
                                                    ...
                                                    <li><i class="fa fa-video text-danger"></i> Basic Tags & Elements</li>
                                                    <li><i class="fa fa-video text-danger"></i> Attributes and Nesting</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Creating Tables in HTML</li>
                                                    <li><i class="fa fa-video text-danger"></i> Table Attributes and Styling</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <ul>
                                                    ...
                                                    <li><i class="fa fa-video text-danger"></i> Input Types and Attributes</li>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Semantic Tags (header, footer, section, etc.)</li>
                                                    <li><i class="fa fa-video text-danger"></i> Accessibility Benefits</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Introduction to CSS</li>
                                                    <li><i class="fa fa-video text-danger"></i> Inline, Internal, and External CSS</li>
                                                    <li><i class="fa fa-video text-danger"></i> Selectors, Classes, IDs</li>
                                                    <li><i class="fa fa-video text-danger"></i> Box Model & Positioning</li>
                                                    <li><i class="fa fa-video text-danger"></i> Flexbox & Grid</li>
                                                    <li><i class="fa fa-video text-danger"></i> Responsive Design with Media Queries</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Variables and Data Types</li>
                                                    <li><i class="fa fa-video text-danger"></i> Conditions and Loops</li>
                                                    <li><i class="fa fa-video text-danger"></i> DOM Manipulation</li>
                                                    <li><i class="fa fa-video text-danger"></i> Form Validation (JavaScript)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseSeven" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Introduction to Bootstrap 5</li>
                                                    <li><i class="fa fa-video text-danger"></i> Grid System & Components</li>
                                                    <li><i class="fa fa-video text-danger"></i> Creating Responsive Layouts</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseEight" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Build a Complete Website</li>
                                                    <li><i class="fa fa-video text-danger"></i> Domain & Hosting Basics</li>
                                                    <li><i class="fa fa-video text-danger"></i> Deploy Website on GitHub Pages / Hosting Provider</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="container" id="Instructor">
                                ...
                                <div class="image-div text-left mt-4">
                                    ...
                                    <div class="des mt-4 mb-5">
                                        Curriculum Director at Codecademy and creative technologist. He has designed a range of Codecademy courses, including Learn HTML, Learn C#, Learn Alexa, and the beginner-friendly Learn How to Code.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 shadow wow fadeInUp" data-wow-delay="0.3s">
                    <div class="image text-center">
                        <img class="img-fluid mt-2" src="{{ asset('img/course-1.jpg') }}" alt="" height="200px" width="500px">
                    </div>

                    <h4 class="mt-2 p-2">Rs.<small><del>80K</del></small></h4>
                    <h4 class="mt-2 p-2">RS.<small>50K</small></h4>
