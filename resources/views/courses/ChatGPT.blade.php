                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">ChatGPT for Beginners</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="container">
                        <div class="row g-5 justify-content-center">
                            <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                                <h2>ChatGPT for Beginners</h2>
                                <p>Start at the beginning by learning the fundamentals of using ChatGPT — including how
                                    to ask effective questions, explore different use cases, understand limitations, and
                                    apply it in everyday tasks. Build a strong foundation for using AI tools to boost
                                ...
                                <div class="d-flex">
                                    ...
                                    <small style="margin-left: 15px;"><i class="fa fa-clock me-2"></i> 15 Days</small>
                                </div>
                    ...
                    <div class="container-fluid wow fadeInUp mt-5 tabs">
                        ...
                        <div class="tab-content mt-4">
                            <div class="tab-pane container active" id="Overview">
                                ...
                                <p>This beginner-friendly ChatGPT course teaches you how to use AI effectively for
                                    everyday tasks. Learn how to ask better questions, generate content, solve problems,
                                    and boost productivity. No technical skills needed — we guide you step by step from
                                    the basics to practical use.
                                </p>
                                <h2 class="mt-4">Skills you'll gain</h2>

                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Problem-solving with ChatGPT</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Time-saving task automation</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Everyday productivity with AI</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Understanding ChatGPT's strengths and limits</span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Brainstorming and idea generation</span>
                            </div>
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> What is ChatGPT?</li>
                                                    <li><i class="fa fa-video text-danger"></i> How ChatGPT Works</li>
                                                    <li><i class="fa fa-video text-danger"></i> Key Use Cases and Benefits</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Writing Clear and Effective Prompts</li>
                                                    <li><i class="fa fa-video text-danger"></i> Understanding Prompt Structure</li>
                                                    <li><i class="fa fa-video text-danger"></i> Prompt Do's and Don'ts</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Content Writing and Editing</li>
                                                    <li><i class="fa fa-video text-danger"></i> Summarizing and Translating</li>
                                                    <li><i class="fa fa-video text-danger"></i> Brainstorming and Idea Generation</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Using ChatGPT for Task Automation</li>
                                                    <li><i class="fa fa-video text-danger"></i> Personal Organization and Planning</li>
                                                    <li><i class="fa fa-video text-danger"></i> Time-Saving AI Techniques</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>

                                    <!-- ChatGPT in Professional Settings -->
                                    <div class="accordion-item">
                                        <h2 class="accordion-header">
                                            <button class="accordion-button collapsed" type="button"
                                        ...
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> ChatGPT for Business Writing</li>
                                                    <li><i class="fa fa-video text-danger"></i> Research and Reports</li>
                                                    <li><i class="fa fa-video text-danger"></i> Customer Support Use Cases</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseSix" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Understanding ChatGPT's Boundaries</li>
                                                    <li><i class="fa fa-video text-danger"></i> Responsible AI Use</li>
                                                    <li><i class="fa fa-video text-danger"></i> Avoiding Misinformation</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseSeven" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Practice Scenarios and Prompts</li>
                                                    <li><i class="fa fa-video text-danger"></i> Creating AI Workflows</li>
                                                    <li><i class="fa fa-video text-danger"></i> Real-World Use Case Exercises</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseEight" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Create a Custom Prompt Library</li>
                                                    <li><i class="fa fa-video text-danger"></i> Design a ChatGPT Use Case for Work or Study</li>
                                                    <li><i class="fa fa-video text-danger"></i> Present Your AI Integration Plan</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="container" id="Instructor">
                                ...
                                <div class="image-div text-left mt-4">
                                    ...
                                    <div class="des mt-4 mb-5">
                                        Curriculum Director at Codecademy and AI education advocate. He has designed a
                                        variety of Codecademy courses, including ChatGPT for Beginners, Prompt
                                        Engineering Basics, and Everyday AI Tools. With a focus on practical and
                                        accessible learning, he helps beginners unlock the power of ChatGPT to enhance
                                        productivity, creativity, and problem-solving across personal and professional
                                        tasks.
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 shadow wow fadeInUp" data-wow-delay="0.3s">
                    <div class="image text-center">
                        <img class="img-fluid mt-2" src="{{ asset('img/course-6.jpg') }}" alt="" height="200px" width="500px">
                    </div>

                    <h4 class="mt-2 p-2">Rs.<small><del>5K</del></small></h4>
                    <h4 class="mt-2 p-2">RS.<small>0</small></h4>
