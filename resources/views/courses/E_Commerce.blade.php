                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">E-Commrace
                            </li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="row">
                    ...
                    <div class="container">
                        <div class="row g-5 justify-content-center">
                            <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                                <h2>E-Commrace</h2>
                                <p>Start at the beginning by learning the fundamentals of e-commerce — including online
                                    store setup, product management, payment integration, and customer experience. Build
                                    a strong foundation for creating, running, and optimizing successful online
                                    businesses.
                    ...
                    <div class="container-fluid wow fadeInUp mt-5 tabs">
                        ...
                        <div class="tab-content mt-4">
                            <div class="tab-pane container active" id="Overview">
                                ...
                                <p>This E-Commerce course is ideal for beginners who want to learn the fundamentals of
                                    online business. You will explore the core concepts of e-commerce, including digital
                                    storefronts, payment gateways, product listings, customer experience, and marketing
                                    strategies. No prior business or technical experience is required — we start from
                                    the basics and guide you step by step. By the end of the course, you will be able to
                                    set up and manage your own e-commerce store and understand how online selling works
                                    at a practical and strategic level.</p>
                                ...
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Understand E-Commerce Business
                                    Models</span>

                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Set Up and Manage Online Stores
                                </span>

                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Work with Product Listings &
                                    Categories
                                </span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Integrate Payment Gateways
                                </span>
                                <span class="badge rounded-pill text-white bg-primary px-4 py-2 m-2"
                                    style="font-size: 15px; font-weight: normal;">Handle Orders, Shipping & Customer
                                    Support
                                </span>
                            </div>
                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> What is E-Commerce?</li>
                                                    <li><i class="fa fa-video text-danger"></i> Types of E-Commerce
                                                        Models</li>
                                                    <li><i class="fa fa-video text-danger"></i> Advantages and
                                                        Challenges</li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Choosing a Platform
                                                        (Shopify, WooCommerce)</li>
                                                    <li><i class="fa fa-video text-danger"></i> Store Structure &
                                                        Navigation</li>
                                                    <li><i class="fa fa-video text-danger"></i> Adding Products and
                                                        Categories</li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Product Titles and
                                                        Descriptions</li>
                                                    <li><i class="fa fa-video text-danger"></i> Pricing Strategies</li>
                                                    <li><i class="fa fa-video text-danger"></i> Inventory Management
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Integrating Payment
                                                        Gateways</li>
                                                    <li><i class="fa fa-video text-danger"></i> Understanding
                                                        Transaction Fees</li>
                                                    <li><i class="fa fa-video text-danger"></i> Optimizing the Checkout
                                                        Experience</li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFive" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Shipping Methods and
                                                        Zones</li>
                                                    <li><i class="fa fa-video text-danger"></i> Dropshipping vs.
                                                        Inventory</li>
                                                    <li><i class="fa fa-video text-danger"></i> Order Tracking and
                                                        Returns</li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseSix" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Introduction to SEO</li>
                                                    <li><i class="fa fa-video text-danger"></i> Email Marketing
                                                        Fundamentals</li>
                                                    <li><i class="fa fa-video text-danger"></i> Social Media Campaigns
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseSeven" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Using Google Analytics
                                                        for E-Commerce</li>
                                                    <li><i class="fa fa-video text-danger"></i> Conversion Rate
                                                        Optimization</li>
                                                    <li><i class="fa fa-video text-danger"></i> A/B Testing and Customer
                                                        Behavior</li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseEight" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Handling Customer
                                                        Inquiries</li>
                                                    <li><i class="fa fa-video text-danger"></i> Managing Reviews and
                                                        Feedback</li>
                                                    <li><i class="fa fa-video text-danger"></i> Building Customer
                                                        Loyalty</li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseNine" class="accordion-collapse collapse"
                                            ...
                                            <div class="accordion-body">
                                                <ul>
                                                    <li><i class="fa fa-video text-danger"></i> Build and Launch a
                                                        Sample Online Store</li>
                                                    <li><i class="fa fa-video text-danger"></i> Apply Marketing and
                                                        Analytics Strategies</li>
                                                    <li><i class="fa fa-video text-danger"></i> Present Your Business
                                                        Plan</li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <div class="container" id="Instructor">
                                ...
                                <div class="image-div text-left mt-4">
                                    ...
                                    <div class="des mt-4 mb-5">
                                        Curriculum Director at Codecademy and digital business strategist. He has
                                        designed a range of Codecademy courses, including Learn E-Commerce, Online Store
                                        Management, and Digital Marketing Essentials. With a strong focus on practical
                                        business skills, he helps beginners launch and grow successful online stores
                                        while understanding the key components of modern e-commerce platforms and
                                        strategies.
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 shadow wow fadeInUp" data-wow-delay="0.3s">
                    <div class="image text-center">
                        <img class="img-fluid mt-2" src="{{ asset('img/course-5.jpg') }}" alt="" height="200px" width="500px">
                    </div>

                    <h4 class="mt-2 p-2">Rs.
                        <small><del>50K</del></small>
                    </h4>
                    <h4 class="mt-2 p-2">RS.
                        <small>30K</small>
                    </h4>
